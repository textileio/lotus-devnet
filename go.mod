...
require (
	...
	github.com/filecoin-project/lotus v1.1.4-0.20201117115131-193630f7b6ae
...
replace github.com/filecoin-project/lotus => github.com/jsign/lotus v0.4.1-0.20201117150654-e9aafc2cd255
